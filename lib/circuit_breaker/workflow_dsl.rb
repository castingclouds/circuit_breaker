  ...
  module WorkflowBuilder
    module DSL
      ...
      class WorkflowBuilder
        ...
        def flow(state_transition, transition_name = nil, &block)
          builder = StateTransitionBuilder.new(self, state_transition)
          builder.transition(transition_name) if transition_name
